  ...
  return (
    <nav className="flex justify-between items-center ">
      ...
      <Link to="/admin/allTours">
        ...
        <button className="bg-blue-500 text-white py-2 px-4 rounded-full  hover:bg-blue-700  font-bold  focus:outline-none focus:shadow-outline">Economic Tours</button>
        </Link>
        <Link to="/admin/businesTours">
        <button className="bg-blue-500 text-white py-2 px-4 rounded-full  hover:bg-blue-700  font-bold  focus:outline-none focus:shadow-outline">Business Tours</button>
        </Link>
      </div>
